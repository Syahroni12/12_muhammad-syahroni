                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <br><br>
                                        <h1 class="h4 text-gray-900 mb-4">Registrasi Akun Aplikasi Peduli Diri</h1>
                                        <h6>Silahkan tambahkan nik dan nama lengkap anda</h6>
                                        <?php
                                        session_start();
                                        if (!empty($_SESSION["sedikit"])) {
                                            echo $_SESSION["sedikit"];
                                            unset($_SESSION["sedikit"]);
                                        }
                                        if (!empty($_SESSION["terdaftar"])) {
                                            echo $_SESSION["terdaftar"];
                                            unset($_SESSION["terdaftar"]);
                                        }

                                        ?>
                                    </div>
                                    <form action="proses_register.php" class="user" method="post" name="forme">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-user btn-block"><i class="fa fa-spinner"></i> Register</button>

                                        </div>
                                        <div class="form-group">
                                            <a href="index.php" class="btn btn-primary btn-user btn-block">Sudah punya akun?Silahkan login<i class=" fa fa-arrow-left fa-fw"></i></a>
